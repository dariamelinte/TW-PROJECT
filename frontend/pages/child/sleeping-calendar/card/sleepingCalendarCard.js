...
import { getSleepingEventById, getSleepingEventByIdRSS } from '/frontend/api/sleeping/getSleepingEventById.js';
...
document.body.appendChild(RSSButton(() => getSleepingEventByIdRSS(id)));
